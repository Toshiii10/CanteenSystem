...
-- Dumping data for table canteen_sales_inventory_system.audit_logs: ~97 rows (approximately)
...
INSERT INTO `customer_profiles` (`customer_id`, `user_id`, `student_employee_no`, `course_department`, `dietary_notes`, `loyalty_points`, `created_at`, `dietary_profile`, `allergen_restrictions`) VALUES
	...
	(3, 6, '2026-1003', 'BSBA', NULL, 35, '2026-06-11 00:29:45', 'NONE', '');
...
INSERT INTO `customer_subscriptions` (`sub_id`, `customer_id`, `plan_id`, `start_date`, `end_date`, `credits_total`, `credits_used`, `status`) VALUES
	...
	(2, 2, 2, '2026-06-01', '2026-07-01', 25, 5, 'ACTIVE'),
	(3, 3, 3, '2026-06-03', '2026-07-03', 40, 0, 'ACTIVE');
...
INSERT INTO `employees` (`employee_id`, `user_id`, `position`, `shift_schedule`, `hired_date`, `status`) VALUES
	...
	(2, 3, 'Cashier', 'Afternoon', NULL, 'ACTIVE');
...
INSERT INTO `ingredients` (`ingredient_id`, `ingredient_name`, `unit`, `quantity_on_hand`, `reorder_level`, `status`, `allergen_tags`) VALUES
	...
	(6, 'Cheese', 'slice', 2.000, 15.000, 'ACTIVE', ''),
	...
	(11, 'Coffee Beans', 'kg', 50.000, 10.000, 'ACTIVE', ''),
	(12, 'Milk', 'liter', 80.000, 15.000, 'ACTIVE', 'DAIRY'),
	(13, 'Tea Powder', 'kg', 40.000, 10.000, 'ACTIVE', ''),
...
-- Dumping data for table canteen_sales_inventory_system.kitchen_queue: ~2 rows (approximately)
...
-- Dumping data for table canteen_sales_inventory_system.orders: ~2 rows (approximately)
INSERT INTO `orders` (`order_id`, `order_no`, `customer_id`, `slot_id`, `order_type`, `table_number`, `ordered_at`, `subtotal`, `discount_amount`, `total_amount`, `amount_paid`, `balance`, `payment_status`, `order_status`, `cashier_id`, `notes`, `inventory_deducted`, `customer_type`, `queue_priority`, `prep_started_at`, `prep_ready_at`, `served_completed_at`, `unclaimed_disposition`) VALUES
	...
	(501, 'ORD-TEST-001', 1, NULL, 'PICKUP', NULL, '2026-06-11 00:26:48', 0.00, 0.00, 120.00, 0.00, 0.00, 'PAID', 'CONFIRMED', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(502, 'ORD-TEST-002', 2, NULL, 'PICKUP', NULL, '2026-06-11 00:26:48', 0.00, 0.00, 95.00, 0.00, 0.00, 'PAID', 'CONFIRMED', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(503, 'ORD-TEST-003', 2, NULL, 'PICKUP', NULL, '2026-06-11 00:26:48', 0.00, 0.00, 165.00, 0.00, 0.00, 'PAID', 'CONFIRMED', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(504, 'ORD-TEST-004', 1, NULL, 'PICKUP', NULL, '2026-06-11 00:26:48', 0.00, 0.00, 45.00, 0.00, 0.00, 'PAID', 'CANCELLED', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(601, 'ORD-2026-A1', 1, NULL, 'PICKUP', NULL, '2026-06-11 00:34:02', 0.00, 0.00, 240.00, 0.00, 0.00, 'PAID', 'COMPLETED', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(701, 'ORD-2026-LIVE1', 1, 3, 'PICKUP', NULL, '2026-06-11 00:38:11', 0.00, 0.00, 240.00, 240.00, 0.00, 'PAID', 'COMPLETED', NULL, NULL, 0, 'REGULAR', 3, '2026-06-11 03:32:00', '2026-06-11 03:44:00', NULL, 'NONE'),
	(702, 'ORD-2026-LIVE2', 2, NULL, 'PICKUP', NULL, '2026-06-11 00:38:11', 0.00, 0.00, 150.00, 0.00, 0.00, 'PENDING', 'PENDING', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(703, 'ORD-2026-LIVE3', 3, NULL, 'PICKUP', NULL, '2026-06-11 00:38:11', 0.00, 0.00, 90.00, 0.00, 0.00, 'UNPAID', 'CONFIRMED', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(704, 'ORD-2026-LIVE4', 1, NULL, 'PICKUP', NULL, '2026-06-11 00:38:11', 0.00, 0.00, 45.00, 45.00, 0.00, 'REFUNDED', 'CANCELLED', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(801, 'ORD-EXP-PMT1', 1, NULL, 'PICKUP', NULL, '2026-06-11 00:41:23', 0.00, 0.00, 170.00, 0.00, 0.00, 'UNPAID', 'CONFIRMED', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(901, 'ORD-DASH-PAY901', 1, NULL, 'PICKUP', NULL, '2026-06-11 00:43:43', 0.00, 0.00, 150.00, 0.00, 0.00, 'UNPAID', 'PENDING', NULL, NULL, 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE');
...
INSERT INTO `products` (`product_id`, `category_id`, `product_name`, `description`, `barcode`, `unit_price`, `preparation_time_minutes`, `image_reference`, `status`, `created_at`, `calories`, `carbohydrates`, `protein`, `fat`, `sugar`, `sodium`) VALUES
	...
	(16, 1, 'Wintermelon Milk Tea', 'Large Size', 'MT001', 85.00, 5, NULL, 'AVAILABLE', '2026-06-11 00:14:31', 320, 42.00, 3.50, 8.00, 38.00, 35.00),
	(17, 1, 'Okinawa Milk Tea', 'Large Size', 'MT002', 90.00, 5, NULL, 'AVAILABLE', '2026-06-11 00:14:31', 340, 45.00, 3.80, 9.00, 40.00, 40.00),
	(18, 2, 'Iced Coffee', 'Cold Coffee', 'CF001', 75.00, 3, NULL, 'AVAILABLE', '2026-06-11 00:14:31', 150, 28.00, 1.00, 2.00, 22.00, 15.00),
	(19, 2, 'Cappuccino', 'Hot Coffee', 'CF002', 80.00, 5, NULL, 'AVAILABLE', '2026-06-11 00:14:31', 180, 24.00, 4.50, 6.00, 18.00, 55.00),
	(20, 3, 'Carbonara', 'Creamy Pasta', 'PS001', 120.00, 10, NULL, 'AVAILABLE', '2026-06-11 00:14:31', 540, 58.00, 18.00, 24.00, 4.00, 620.00),
	(21, 4, 'Chicken Sandwich', 'Club Sandwich', 'SW001', 95.00, 8, NULL, 'AVAILABLE', '2026-06-11 00:14:31', 380, 32.00, 22.00, 12.00, 3.50, 510.00),
	(22, 5, 'Chocolate Muffin', 'Fresh Muffin', 'PF001', 45.00, 2, NULL, 'AVAILABLE', '2026-06-11 00:14:31', 290, 38.00, 4.00, 10.00, 24.00, 180.00);
...
INSERT INTO `users` (`user_id`, `username`, `password_hash`, `full_name`, `email`, `phone`, `address`, `role`, `status`, `created_at`, `updated_at`) VALUES
	...
	(7, 'student1', 'stud123', 'Carlo Reyes', 'student1@gmail.com', '09170000004', 'Quezon City', 'CUSTOMER', 'ACTIVE', '2026-06-11 00:14:31', '2026-06-11 00:14:31'),
...
INSERT INTO `wallets` (`wallet_id`, `customer_id`, `balance`, `subsidy_balance`, `daily_limit`, `parent_sponsor_name`, `parent_contact`) VALUES
	(1, 1, 350.00, 120.00, 150.00, 'Engr. Roberto Reyes', '0917-123-4567'),
