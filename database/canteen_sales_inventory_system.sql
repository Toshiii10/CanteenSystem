...
CREATE TABLE IF NOT EXISTS `announcements` (
  ...
  `target_role` enum('ALL','ADMIN','CUSTOMER') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'ALL',
...
-- Dumping data for table canteen_sales_inventory_system.audit_logs: ~145 rows (approximately)
INSERT INTO `audit_logs` (`log_id`, `user_id`, `action`, `details`, `created_at`) VALUES
	...
	(96, 1, 'LOGIN', 'Successful login', '2026-06-08 05:51:48'),
	(97, 1, 'KITCHEN_START_PREP', '1', '2026-06-08 05:52:02'),
	(98, 1, 'KITCHEN_START_PREP', '1', '2026-06-08 05:52:03'),
	(99, 1, 'KITCHEN_MARK_READY', '1', '2026-06-08 05:52:07'),
	(100, 1, 'LOGIN', 'Successful login', '2026-06-08 09:04:12'),
	(101, 1, 'LOGOUT', 'System Manager logged out cleanly from administrative root terminal', '2026-06-08 09:04:24'),
	(102, 3, 'LOGIN', 'Successful login', '2026-06-08 09:04:31'),
	(103, 3, 'LOGOUT', 'Customer clicked explicit workspace header logout button', '2026-06-08 09:04:51'),
	(104, 1, 'LOGIN', 'Successful login', '2026-06-16 14:19:33'),
	(105, 1, 'LOGIN', 'Successful login', '2026-06-16 14:23:57'),
	(106, 1, 'KITCHEN_START_PREP', '101', '2026-06-16 14:24:43'),
	(107, 1, 'LOGIN', 'Successful login', '2026-06-16 14:38:32'),
	(108, 1, 'KITCHEN_START_PREP', '102', '2026-06-16 14:39:08'),
	(109, 3, 'LOGIN', 'Successful login', '2026-06-16 14:40:36'),
	(110, 3, 'UPDATE_PROFILE', 'Updated profile nutrition preferences', '2026-06-16 14:40:54'),
	(111, 1, 'LOGIN', 'Successful login', '2026-06-16 14:41:15'),
	(112, 3, 'CANCEL_ORDER', 'Order ID: 105', '2026-06-16 14:43:53'),
	(113, 1, 'LOGIN', 'Successful login', '2026-06-16 14:45:14'),
	(114, 1, 'LOGIN', 'Successful login', '2026-06-16 14:46:19'),
	(115, 3, 'LOGIN', 'Successful login', '2026-06-16 14:47:02'),
	(116, 1, 'UPDATE_ingredients', 'ingredient_id=7', '2026-06-16 14:47:19'),
	(117, 1, 'UPDATE_ingredients', 'ingredient_id=6', '2026-06-16 14:47:34'),
	(118, 1, 'UPDATE_ingredients', 'ingredient_id=5', '2026-06-16 14:47:39'),
	(119, 1, 'UPDATE_ingredients', 'ingredient_id=2', '2026-06-16 14:48:03'),
	(120, 1, 'UPDATE_ingredients', 'ingredient_id=1', '2026-06-16 14:48:09'),
	(121, 1, 'UPDATE_ingredients', 'ingredient_id=3', '2026-06-16 14:48:18'),
	(122, 1, 'UPDATE_ingredients', 'ingredient_id=2', '2026-06-16 14:48:37'),
	(123, 1, 'UPDATE_ingredients', 'ingredient_id=8', '2026-06-16 14:48:42'),
	(124, 1, 'UPDATE_ingredients', 'ingredient_id=9', '2026-06-16 14:48:47'),
	(125, 1, 'UPDATE_ingredients', 'ingredient_id=4', '2026-06-16 14:48:51'),
	(126, 3, 'UPDATE_PROFILE', 'Updated profile nutrition preferences', '2026-06-16 14:48:55'),
	(127, 1, 'UPDATE_RECIPE', 'Product ID: 3, Ing ID: 5', '2026-06-16 14:49:01'),
	(128, 3, 'UPDATE_PROFILE', 'Updated profile nutrition preferences', '2026-06-16 14:49:08'),
	(129, 3, 'UPDATE_PROFILE', 'Updated profile nutrition preferences', '2026-06-16 14:49:23'),
	(130, 3, 'UPDATE_PROFILE', 'Updated profile nutrition preferences', '2026-06-16 14:49:35'),
	(131, 3, 'LOGIN', 'Successful login', '2026-06-16 14:51:01'),
	(132, 3, 'UPDATE_PROFILE', 'Updated profile nutrition preferences', '2026-06-16 14:51:22'),
	(133, 3, 'LOGOUT', 'Customer clicked explicit workspace header logout button', '2026-06-16 14:52:02'),
	(134, 1, 'LOGIN', 'Successful login', '2026-06-16 14:52:07'),
	(135, 1, 'LOGOUT', 'System Manager logged out cleanly from administrative root terminal', '2026-06-16 14:55:57'),
	(136, 3, 'LOGIN', 'Successful login', '2026-06-16 14:56:11'),
	(137, 3, 'LOGOUT', 'Customer clicked explicit workspace header logout button', '2026-06-16 14:56:30'),
	(138, 4, 'LOGIN', 'Successful login', '2026-06-16 14:57:43'),
	(139, 1, 'LOGIN', 'Successful login', '2026-06-16 15:10:25'),
	(140, 1, 'KITCHEN_START_PREP', '102', '2026-06-16 15:11:10'),
	(141, 1, 'LOGOUT', 'System Manager logged out cleanly from administrative root terminal', '2026-06-16 15:12:41'),
	(142, 3, 'LOGIN', 'Successful login', '2026-06-16 15:12:48'),
	(143, 1, 'LOGIN', 'Successful login', '2026-06-16 15:13:39'),
	(144, 1, 'KITCHEN_START_PREP', '107', '2026-06-16 15:14:11'),
	(145, 1, 'KITCHEN_MARK_READY', '107', '2026-06-16 15:14:13');
...
CREATE TABLE IF NOT EXISTS `customer_profiles` (
  ...
  `student_employee_no` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `course_department` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dietary_notes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `loyalty_points` int NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `dietary_profile` enum('NONE','DIABETIC_FRIENDLY','LOW_SODIUM','VEGETARIAN','HALAL') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NONE',
  `allergen_restrictions` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
-- Dumping data for table canteen_sales_inventory_system.customer_profiles: ~3 rows (approximately)
INSERT INTO `customer_profiles` (`customer_id`, `user_id`, `student_employee_no`, `course_department`, `dietary_notes`, `loyalty_points`, `created_at`, `dietary_profile`, `allergen_restrictions`) VALUES
	(1, 3, '2026-0001', 'Computer Engineering', 'No allergies', 20, '2026-05-25 15:11:24', 'LOW_SODIUM', 'gluten'),
	(2, 1, 'EMP-2026-001', 'Canteen Operations Root', NULL, 150, '2026-06-08 04:29:17', 'NONE', ''),
	(3, 4, '2024-07268-MN-0', 'Computer Engineering Department', 'None', 0, '2026-06-16 14:57:41', 'NONE', '');
...
-- Dumping data for table canteen_sales_inventory_system.customer_subscriptions: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `employees` (
  ...
  `shift_schedule` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `feedback` (
  ...
  `status` enum('VISIBLE','HIDDEN') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'VISIBLE',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `ingredients` (
  ...
  `ingredient_name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `status` enum('ACTIVE','INACTIVE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'ACTIVE',
  `allergen_tags` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `ingredients` (`ingredient_id`, `ingredient_name`, `unit`, `quantity_on_hand`, `reorder_level`, `status`, `allergen_tags`) VALUES
	(1, 'Rice', 'kg', 30.000, 10.000, 'ACTIVE', 'GLUTEN'),
	(2, 'Chicken', 'kg', 15.000, 5.000, 'ACTIVE', 'None'),
	(3, 'Adobo Sauce', 'liter', 8.000, 2.000, 'ACTIVE', 'SOY'),
	(4, 'Siomai', 'pcs', 120.000, 40.000, 'ACTIVE', 'None'),
	(5, 'Bread Slice', 'pcs', 100.000, 30.000, 'ACTIVE', 'GLUTEN'),
	(6, 'Cheese', 'slice', 80.000, 20.000, 'ACTIVE', 'DAIRY'),
	(7, 'Iced Tea Mix', 'gram', 1000.000, 300.000, 'ACTIVE', 'DAIRY'),
	(8, 'Cup 16oz', 'pcs', 100.000, 30.000, 'ACTIVE', 'None'),
	(9, 'Banana Turon', 'pcs', 70.000, 20.000, 'ACTIVE', 'None');
...
CREATE TABLE IF NOT EXISTS `ingredient_batches` (
  ...
  `batch_number` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `received_date` date NOT NULL,
  `expiry_date` date DEFAULT NULL,
  `quantity_received` decimal(12,3) NOT NULL,
  `quantity_available` decimal(12,3) NOT NULL,
  `unit_cost` decimal(12,2) NOT NULL DEFAULT '0.00',
  `status` enum('AVAILABLE','EMPTY','EXPIRED','DISPOSED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'AVAILABLE',
...
CREATE TABLE IF NOT EXISTS `inventory_adjustments` (
  ...
  `adjustment_type` enum('ADD','DEDUCT','SPOILAGE','WASTAGE','CORRECTION') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `meal_plans` (
  ...
  `plan_type` enum('WEEKLY','MONTHLY','BUNDLE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `messages` (
  ...
  `body` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('SENT','READ','CLOSED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'SENT',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `notifications` (`notification_id`, `user_id`, `title`, `body`, `status`, `created_at`) VALUES
	(1, 3, 'Order Ready Alert', 'Your Canteen Order is Hot and Ready for Pickup! Please proceed to the counter.', 'UNREAD', '2026-06-16 15:14:13');
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `order_type` enum('WALK_IN','PICKUP','DINE_IN') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'PICKUP',
  ...
  `payment_status` enum('UNPAID','PENDING','PAID','REFUNDED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'UNPAID',
  `order_status` enum('PENDING','CONFIRMED','PREPARING','READY','COMPLETED','CANCELLED','REJECTED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'PENDING',
  `cashier_id` int DEFAULT NULL,
  `notes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `inventory_deducted` tinyint(1) DEFAULT '0',
  `customer_type` enum('REGULAR','FACULTY','PWD','SENIOR','EMERGENCY') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'REGULAR',
  ...
  `unclaimed_disposition` enum('NONE','REFUNDED','DISPOSED_WASTAGE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NONE',
...
-- Dumping data for table canteen_sales_inventory_system.orders: ~14 rows (approximately)
INSERT INTO `orders` (`order_id`, `order_no`, `customer_id`, `slot_id`, `order_type`, `table_number`, `ordered_at`, `subtotal`, `discount_amount`, `total_amount`, `amount_paid`, `balance`, `payment_status`, `order_status`, `cashier_id`, `notes`, `inventory_deducted`, `customer_type`, `queue_priority`, `prep_started_at`, `prep_ready_at`, `served_completed_at`, `unclaimed_disposition`) VALUES
	(101, 'ORD-2026-0001', 1, NULL, 'PICKUP', NULL, '2026-06-08 04:31:28', 0.00, 0.00, 120.00, 0.00, 0.00, 'PAID', 'PREPARING', NULL, NULL, 0, 'REGULAR', 3, '2026-06-16 14:24:43', NULL, NULL, 'NONE'),
	(102, 'ORD-2026-0002', 2, NULL, 'PICKUP', NULL, '2026-06-08 04:31:28', 0.00, 0.00, 115.00, 0.00, 0.00, 'PAID', 'PREPARING', NULL, NULL, 0, 'REGULAR', 3, '2026-06-16 15:11:10', NULL, NULL, 'NONE'),
	...
	(104, 'ORD-20260616224324965', 1, 6, 'PICKUP', NULL, '2026-06-16 14:43:24', 7500.00, 0.00, 7500.00, 0.00, 7500.00, 'UNPAID', 'CANCELLED', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(105, 'ORD-20260616224336642', 1, 6, 'PICKUP', NULL, '2026-06-16 14:43:36', 7500.00, 0.00, 7500.00, 0.00, 7500.00, 'UNPAID', 'CANCELLED', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(106, 'ORD-20260616225752642', 3, 1, 'PICKUP', NULL, '2026-06-16 14:57:52', 20.00, 0.00, 20.00, 0.00, 20.00, 'UNPAID', 'PENDING', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(107, 'ORD-20260616231358555', 1, 1, 'PICKUP', NULL, '2026-06-16 15:13:58', 20.00, 0.00, 20.00, 20.00, 0.00, 'PAID', 'READY', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, '2026-06-16 15:14:11', '2026-06-16 15:14:13', NULL, 'NONE'),
	(108, 'ORD-20260616231837489', 1, 1, 'PICKUP', NULL, '2026-06-16 15:18:37', 55.00, 0.00, 55.00, 55.00, 0.00, 'PAID', 'PENDING', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(109, 'ORD-20260616231840712', 1, 1, 'PICKUP', NULL, '2026-06-16 15:18:40', 95.00, 0.00, 95.00, 0.00, 95.00, 'UNPAID', 'CANCELLED', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(110, 'ORD-20260616231847504', 1, 1, 'PICKUP', NULL, '2026-06-16 15:18:47', 95.00, 0.00, 95.00, 0.00, 95.00, 'UNPAID', 'PENDING', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(111, 'ORD-20260616231850616', 1, 1, 'PICKUP', NULL, '2026-06-16 15:18:50', 20.00, 0.00, 20.00, 0.00, 20.00, 'UNPAID', 'PENDING', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(112, 'ORD-20260616231854832', 1, 1, 'PICKUP', NULL, '2026-06-16 15:18:54', 75.00, 0.00, 75.00, 0.00, 75.00, 'UNPAID', 'PENDING', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(113, 'ORD-20260616231857607', 1, 1, 'PICKUP', NULL, '2026-06-16 15:18:57', 30.00, 0.00, 30.00, 0.00, 30.00, 'UNPAID', 'PENDING', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE'),
	(114, 'ORD-20260616231900863', 1, 1, 'PICKUP', NULL, '2026-06-16 15:19:00', 85.00, 0.00, 85.00, 0.00, 85.00, 'UNPAID', 'PENDING', NULL, 'Scheduled pickup', 0, 'REGULAR', 3, NULL, NULL, NULL, 'NONE');
...
CREATE TABLE IF NOT EXISTS `order_items` (
  ...
  `special_instruction` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table canteen_sales_inventory_system.order_items: ~15 rows (approximately)
INSERT INTO `order_items` (`order_item_id`, `order_id`, `product_id`, `quantity`, `unit_price`, `line_total`, `special_instruction`) VALUES
	...
	(6, 104, 7, 100, 75.00, 7500.00, ''),
	(7, 105, 7, 100, 75.00, 7500.00, ''),
	(8, 106, 5, 1, 20.00, 20.00, ''),
	(9, 107, 5, 1, 20.00, 20.00, ''),
	(10, 108, 11, 1, 55.00, 55.00, ''),
	(11, 109, 8, 1, 95.00, 95.00, ''),
	(12, 110, 8, 1, 95.00, 95.00, ''),
	(13, 111, 5, 1, 20.00, 20.00, ''),
	(14, 112, 1, 1, 75.00, 75.00, ''),
	(15, 113, 13, 1, 30.00, 30.00, ''),
	(16, 114, 6, 1, 85.00, 85.00, '');
...
CREATE TABLE IF NOT EXISTS `payments` (
  ...
  `amount` decimal(12,2) NOT NULL,
  `method` enum('CASH','GCASH','MAYA','BANK_TRANSFER','E_WALLET') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `reference_no` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `proof_reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `image_reference` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('AVAILABLE','UNAVAILABLE','INACTIVE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'AVAILABLE',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dumping data for table canteen_sales_inventory_system.products: ~15 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `promotions` (
  ...
  `promo_name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `promo_code` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `discount_type` enum('PERCENT','FIXED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'PERCENT',
...
CREATE TABLE IF NOT EXISTS `purchase_items` (
  ...
  `line_total` decimal(12,2) NOT NULL,
  `batch_number` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `expiry_date` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `purchase_orders` (
  ...
  `status` enum('DRAFT','ORDERED','PARTIALLY_RECEIVED','RECEIVED','CANCELLED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'DRAFT',
  `created_by` int DEFAULT NULL,
  `notes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `stock_movements` (
  ...
  `ingredient_id` int NOT NULL,
  `movement_type` enum('PURCHASE','SALE_USAGE','ADJUSTMENT','WASTE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `reference_table` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `suppliers` (
  ...
  `contact_person` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `password_hash` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`user_id`, `username`, `password_hash`, `full_name`, `email`, `phone`, `address`, `role`, `status`, `created_at`, `updated_at`) VALUES
	...
	(4, 'carl', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'Carl', 'carlmanantan@gmail.com', '09153442288', 'San Mateo, Rizal', 'CUSTOMER', 'ACTIVE', '2026-06-16 14:57:41', '2026-06-16 14:57:41');
...
CREATE TABLE `v_current_inventory` (
	...
	`stock_status` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci'
) ENGINE=MyISAM;
...
CREATE TABLE `v_peak_hour_analytics` (
	...
	`time_window` VARCHAR(1) NULL COLLATE 'utf8mb4_0900_ai_ci',
...
CREATE TABLE IF NOT EXISTS `wallets` (
  ...
  `parent_sponsor_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `parent_contact` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`wallet_id`),
  UNIQUE KEY `customer_id` (`customer_id`),
  CONSTRAINT `wallets_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer_profiles` (`customer_id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table canteen_sales_inventory_system.wallets: ~2 rows (approximately)
INSERT INTO `wallets` (`wallet_id`, `customer_id`, `balance`, `subsidy_balance`, `daily_limit`, `parent_sponsor_name`, `parent_contact`) VALUES
	(1, 1, 465.00, 75.00, 150.00, 'Mr. Spenser Carl', '0917-123-4567'),
...
CREATE TABLE IF NOT EXISTS `wallet_transactions` (
  ...
  `txn_type` enum('LOAD','SUBSIDY_CREDIT','DEDUCT','REFUND') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table canteen_sales_inventory_system.wallet_transactions: ~7 rows (approximately)
INSERT INTO `wallet_transactions` (`txn_id`, `wallet_id`, `amount`, `txn_type`, `reference_order_id`, `description`, `txn_date`) VALUES
	...
	(6, 1, 20.00, 'DEDUCT', 107, NULL, '2026-06-16 15:13:58'),
	(7, 1, 55.00, 'DEDUCT', 108, NULL, '2026-06-16 15:18:37');
