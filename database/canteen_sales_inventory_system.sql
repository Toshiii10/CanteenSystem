...
-- Dumping data for table canteen_sales_inventory_system.audit_logs: ~95 rows (approximately)
...
-- Dumping data for table canteen_sales_inventory_system.customer_profiles: ~2 rows (approximately)
...
-- Dumping data for table canteen_sales_inventory_system.orders: ~3 rows (approximately)
...
-- Dumping data for table canteen_sales_inventory_system.order_items: ~5 rows (approximately)
...
-- Dumping data for table canteen_sales_inventory_system.wallet_transactions: ~5 rows (approximately)
