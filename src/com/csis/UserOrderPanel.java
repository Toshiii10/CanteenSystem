...
public class UserOrderPanel extends JPanel {
    ...
    // THE FIX: Cleaned up payment options, added BANK TRANSFER
    ...
    public UserOrderPanel(UserSession session) {
        ...
        // THE FIX: Anti-Spam Button Freeze Implemented Here
    ...
    private void loadActiveSlots() {
        ...
        // THE FIX: Capacity logic without dating constraints
        ...
        try {
            ...
            try {
                ...
                if ("MEAL SUBSCRIPTION CREDIT".equals(method)) {
                    ...
                    // THE FIX: Added 'end_date >= CURDATE()' and 'FOR UPDATE' (Row Lock)
                    ...
                    // THE FIX: Added 'end_date >= CURDATE()' here to strictly enforce date checks!
