...
public class UserPaymentsPanel extends JPanel {
    ...
    // This panel allows customers to submit payment information for their orders. 
    // It includes a form for entering payment details such as Order ID, Amount, Payment Method, Reference Number, and Proof of Payment 
    // (which could be a transaction ID or a link to a receipt). 
    ...
    // Validates the input and submits the payment information to the administration for verification, 
    // then refreshes the data and clears the form.
