...
public class AdminFrame extends JFrame { 
    ...
    private void buildTabs(JTabbedPane t) {
       ...
       t.addTab("Allocate Subscriptions", crud("Active Customer Subscriptions", "customer_subscriptions", "sub_id", 
            ...
            "SELECT cs.sub_id, cs.customer_id, u.full_name AS 'Full Name', cs.plan_id, cs.start_date, cs.end_date, cs.credits_total, cs.credits_used, cs.status " +
        ...
        t.addTab("Wallet Transaction Ledger", new UserSimplePanel("System-Wide Prepaid Transactions", 
            "SELECT wt.txn_id AS 'Txn ID', u.full_name AS 'Account Name', wt.amount AS 'Amount', " +
            "wt.txn_type AS 'Txn Type', wt.reference_order_id AS 'Order Ref', wt.txn_date AS 'Date' " +
