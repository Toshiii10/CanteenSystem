...
public class AdminFrame extends JFrame { 
    ...
    private void buildTabs(JTabbedPane t) {
        ...
        // RECIPE MANAGEMENT INJECTED HERE
...
// Embedded RecipeManagementPanel (Upgraded with Universal Search & Titled Form)
class RecipeManagementPanel extends JPanel {
    ...
    private final JTextField searchField = new JTextField(18); // Added Search
    ...
    public RecipeManagementPanel(UserSession session) {
        ...
        // HEADER (NORTH) - Standardized layout
        JPanel headerPanel = new JPanel(new BorderLayout());
        ...
        // FORM (EAST) - Universal "Recipe Text Design"
    ...
    private void loadData() {
        try {
            model.load("""
                ...
                ORDER BY p.product_name ASC, i.ingredient_name ASC
                """);
        } catch (Exception e) { e.printStackTrace(); }
    }
